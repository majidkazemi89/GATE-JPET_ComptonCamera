...
#include <TLegend.h>
void InterDetEfficiencyArticle()
{
...
TH1F *hr = pad->DrawFrame(0,0,110,5);
//hr->SetTitle("Detection Efficiency for different inter-detector distances");
hr->SetXTitle("Inter-detector Distances (mm)");
...
Int_t n1 = 6;
Double_t x1[] = {10,20,40,60,80,100};
Double_t y1[] = {4.23,3.46,2.57,1.86,1.33,1.01};
...
// create second graph
Int_t n2 = 6;
Float_t x2[] = {10,20,40,60,80,100};
Float_t y2[] = {3.12,2.68,2.09,1.56,1.11,0.68};
