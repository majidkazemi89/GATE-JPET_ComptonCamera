...
path='/Users/aetxebeste/gateworkdir/JPET/sim/output/'
nameSeqCoin="test2_sequenceCoincidence.root"
...
pS = file_SeqCoinc['sequenceCoincidence']
coincID_SeqCoinc=pS['coincID'].array(library="np")
evtID_SeqCoinc=pS['eventID'].array(library="np")
edep_SeqCoinc=pS['energy'].array(library="np")*1000#keV
posZ_SeqCoinc=pS['globalPosZ'].array(library="np")
posX_SeqCoinc=pS['globalPosX'].array(library="np")
posY_SeqCoinc=pS['globalPosY'].array(library="np")
posZ_SeqCoinc=pS['globalPosZ'].array(library="np")

Eini_SeqCoinc=[]
EFin_SeqCoinc=[]
if IsIdealdata==True:
    Eini_SeqCoinc=pS['energyIni'].array(library="np")*1000#keV
    EFin_SeqCoinc=pS['energyFinal'].array(library="np")*1000#keV
