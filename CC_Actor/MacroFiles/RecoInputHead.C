...
void Convert() {
   ...
   //TFile *input = TFile::Open("./output/1_head10e7/test2_sequenceCoincidence.root");
   TFile *input = TFile::Open("./output/test2_sequenceCoincidence.root");
   //TFile *input = TFile::Open("./output/CC_real_sequenceCoincidence.root");
   ...
   for (Int_t ievt=0; ievt < theTree->GetEntries();ievt++) {
        ...
        if (coinc_count[ievt].second == 2 && coinc_count[ievt].first == coinc_count[ievt+1].first) {
           ...
           if (globalPosX >= 300.25 && globalPosX <= 324.25) {
              ...
              //Energy_1 = energy;
              Energy_1 = energyIni - energyFinal;
              EnFin_1 = energyFinal;
              EnIni_1 = energyIni;
              PosX_11 = 0;
              PosY_11 = 0;
              ...
              } else if (globalPosX >= 436.25 && globalPosX <= 460.25) {
           ...
           } else if (globalPosX >= 368.25 && globalPosX <= 392.25) {
              ...
              //volumeID_1[ievt] = volumeID[ievt];
               ...
               theTree->GetEntry(ievt+1);
               if (globalPosX >= 436.25 && globalPosX <= 460.25) {
